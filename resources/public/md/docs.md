...
Two middleware functions by default which are are located in the `precure-dcd.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `precure-dcd.handler` namespace to manage the enabled middleware.
